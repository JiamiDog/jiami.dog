---
title: "使用ChatGPT搭建微信聊天机器人,基于OpenAI API和itchat实现"
slug: "use-chatgpt-to-build-wechat-chat-robot-based-on-openai-api"
source_id: "4537"
canonical_url: "https://jiami.dog/4537.html"
date_local: "2023-02-16T22:38:30"
date_published: "2023-02-16T14:38:30Z"
date_modified_local: "2026-07-30T14:38:16"
date_modified: "2026-07-30T06:38:16Z"
draft: false
featured_image_url: "https://jiami.dog/wp-content/uploads/2023/02/144fcfb39cb7cc9d067efc4cc4e47728.jpg"
featured_image_alt: "微信聊天机器人界面，显示“ChatGPT测试群(4)”和系统消息。"
categories:
  - "资源攻略"
tags:
  - "openai"
...
> 本文同步自 [jiami.dog 官方原文](https://jiami.dog/4537.html)，以官网版本为准。

GitHub项目地址：<https://github.com/zhayujie/chatgpt-on-wechat>

# 简介

> ChatGPT近期以强大的对话和信息整合能力风靡全网，可以写代码、改论文、讲故事，几乎无所不能，这让人不禁有个大胆的想法，能否用他的对话模型把我们的[微信](https://jiami.dog/tag/wechat "微信")打造成一个智能机器人，可以在与好友对话中给出意想不到的回应，而且再也不用担心女朋友影响我们 ~~打游戏~~ 工作了。
...
> **2023.02.05：** 在[openai](https://jiami.dog/tag/opens "openai")官方接口方案中 (GPT-3模型) 实现上下文对话
...
> **2022.12.17：** 原来的方案是从 [ChatGPT页面](https://chat.openai.com/chat) 获取session\_token，使用 [revChatGPT](https://github.com/acheong08/ChatGPT) 直接访问web接口，但随着ChatGPT接入Cloudflare人机验证，这一方案难以在服务器顺利运行。 所以目前使用的方案是调用 OpenAI 官方提供的 [API](https://beta.openai.com/docs/api-reference/introduction)，回复质量上基本接近于ChatGPT的内容，劣势是暂不支持有上下文记忆的对话，优势是稳定性和响应速度较好。

# 使用效果

### 个人聊天

[![single-chat-sample.jpg](https://i0.wp.com/jiami.dog/wp-content/uploads/2023/02/dbd34fee523ee64837ad9377420538d6.jpg?ssl=1)](https://i0.wp.com/github.com/zhayujie/chatgpt-on-wechat/blob/master/docs/images/single-chat-sample.jpg?ssl=1)

### 群组聊天

[![group-chat-sample.jpg](https://i0.wp.com/jiami.dog/wp-content/uploads/2023/02/144fcfb39cb7cc9d067efc4cc4e47728.jpg?ssl=1)](https://i0.wp.com/github.com/zhayujie/chatgpt-on-wechat/blob/master/docs/images/group-chat-sample.jpg?ssl=1)

### 图片生成

[![group-chat-sample.jpg](https://i0.wp.com/jiami.dog/wp-content/uploads/2023/02/9965583fed2017024a18ad3afbdba3c0.jpg?ssl=1)](https://i0.wp.com/github.com/zhayujie/chatgpt-on-wechat/blob/master/docs/images/image-create-sample.jpg?ssl=1)

# 快速开始

## 准备

### 1. [OpenAI账号注册](https://jiami.dog/4544.html)

前往 [OpenAI注册页面](https://beta.openai.com/signup) 创建账号，参考这篇 [教程](https://jiami.dog/4427.html "OpenAI 推出超神 ChatGPT 注册攻略") 可以通过[虚拟手机号来接收验证码](https://jiami.dog/4622.html)。创建完账号则前往 [API管理页面](https://beta.openai.com/account/api-keys) 创建一个 API Key 并保存下来，后面需要在项目中配置这个key。
